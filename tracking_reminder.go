...
type TrackingReminder struct {
	...
	LastReminded time.Time `json:"lastReminded,omitempty"`
	...
	FirstDailyReminderTime string `json:"firstDailyReminderTime,omitempty"`

	// Specific second time of day that the user should be reminded to track in UTC HH:MM:SS format
	SecondDailyReminderTime string `json:"secondDailyReminderTime,omitempty"`

	// Specific third time of day that the user should be reminded to track in UTC HH:MM:SS format
	ThirdDailyReminderTime string `json:"thirdDailyReminderTime,omitempty"`
