...
func (a AuthenticationApi) V2AuthSocialAuthorizeCodeGet(code string, provider string) (*APIResponse, error) {
	...
	localVarPath := a.Configuration.BasePath + "/v2/auth/social/authorizeCode"
	...
	var localVarAPIResponse = &APIResponse{Operation: "V2AuthSocialAuthorizeCodeGet", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
...
func (a AuthenticationApi) V2AuthSocialAuthorizeTokenGet(accessToken string, provider string, refreshToken string) (*APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v2/auth/social/authorizeToken"
	...
	for key := range a.Configuration.DefaultHeader {
		...
		localVarQueryParams.Add("refreshToken", a.Configuration.APIClient.ParameterToString(refreshToken, ""))
		localVarQueryParams.Add("accessToken", a.Configuration.APIClient.ParameterToString(accessToken, ""))
		localVarQueryParams.Add("provider", a.Configuration.APIClient.ParameterToString(provider, ""))
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "V2AuthSocialAuthorizeTokenGet", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a AuthenticationApi) V2AuthSocialLoginGet(redirectUrl string, provider string) (*APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v2/auth/social/login"
	...
	for key := range a.Configuration.DefaultHeader {
		...
		localVarQueryParams.Add("redirectUrl", a.Configuration.APIClient.ParameterToString(redirectUrl, ""))
		localVarQueryParams.Add("provider", a.Configuration.APIClient.ParameterToString(provider, ""))
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "V2AuthSocialLoginGet", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a AuthenticationApi) V2Oauth2AccessTokenGet(clientId string, clientSecret string, grantType string, code string, responseType string, scope string, redirectUri string, state string) (*APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v2/oauth2/access_token"
	...
	for key := range a.Configuration.DefaultHeader {
		...
		localVarQueryParams.Add("clientId", a.Configuration.APIClient.ParameterToString(clientId, ""))
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "V2Oauth2AccessTokenGet", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
...
func (a AuthenticationApi) V2OauthAuthorizeGet(clientId string, clientSecret string, responseType string, scope string, redirectUri string, state string) (*APIResponse, error) {
	...
	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v2/oauth/authorize"
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "V2OauthAuthorizeGet", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
