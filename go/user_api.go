 ...
 */
func (a UserApi) V1OrganizationsOrganizationIdUsersPost(organizationId int32, body UserTokenRequest, accessToken string, userId int32) (*UserTokenSuccessfulResponse, *APIResponse, error) {
...
func (a UserApi) V1UserMeGet() (*User, *APIResponse, error) {
	...
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/v1/user/me"
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "V1UserMeGet", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
