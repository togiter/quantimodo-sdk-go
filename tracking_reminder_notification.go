...
type TrackingReminderNotification struct {

	// id for the specific PENDING tracking remidner
	Id int32 `json:"id,omitempty"`

	// id for the repeating tracking remidner
	TrackingReminderId int32 `json:"trackingReminderId,omitempty"`
	...
	PendingReminderTime time.Time `json:"pendingReminderTime,omitempty"`
