...
type Measurement struct {
	...
	StoredAbbreviatedUnitName string `json:"storedAbbreviatedUnitName,omitempty"`

	// Original Unit of measurement as originally submitted
	OriginalAbbreviatedUnitName string `json:"originalAbbreviatedUnitName,omitempty"`
